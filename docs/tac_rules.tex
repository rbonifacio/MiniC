...
\newcommand{\mln}[1]{\hbox{$\displaystyle\strut#1$}}
      ...
      \begin{block}{Rule}
        ...
        \[
          \inferrule[IfElse]
            ...
            {\vcenter{
              \mln{\trStmt{\texttt{if}\,(c)\;s_1\;\texttt{else}\;s_2} \;\Rightarrow}
              \mln{\quad I_c \cat I_t \cat [\texttt{goto}\ L_{\mathrm{end}}]}
              \mln{\quad\cat [L_e\texttt{:}] \cat I_f \cat [L_{\mathrm{end}}\texttt{:}]}
            }}
        \]
        \vspace{0.2em}
      \end{block}
      ...
      \begin{block}{Rule}
        ...
        \[
          \inferrule[Rel]
            ...
            {\vcenter{
              \mln{\trCond{e_1\ \mathit{op}\ e_2}{L_f} \;\Rightarrow}
              \mln{\quad I_1 \cat I_2 \cat [\texttt{if}\ a_1\ \overline{\mathit{op}}\ a_2\ \texttt{goto}\ L_f]}
            }}
        \]
        \vspace{0.2em}
      \end{block}
      ...
      \begin{block}{Rules}
        ...
        \[
          \inferrule[CondIdent]
            { }
            {\vcenter{
              \mln{\trCond{x}{L_f} \;\Rightarrow}
              \mln{\quad[\,\texttt{if\_false}\ x\ \texttt{goto}\ L_f\,]}
            }}
        \]
        \vspace{0.2em}
      \end{block}
      ...
      \begin{block}{Rule}
        ...
        \[
          \inferrule[Or]
            ...
            {\vcenter{
              \mln{\trCond{e_1 \mathbin{\texttt{||}} e_2}{L_f} \;\Rightarrow}
              \mln{\quad I_1 \cat [\texttt{if}\ a_1\ \texttt{goto}\ L_{\mathrm{skip}}]}
              \mln{\quad\cat I_2 \cat [L_{\mathrm{skip}}\texttt{:}]}
            }}
        \]
        \vspace{0.2em}
      \end{block}
      ...
      \begin{block}{Rule}
        ...
        \[
          \inferrule[NotExpr]
            ...
            {\vcenter{
              \mln{\trExpr{\texttt{!}e} \;\Rightarrow\; \bigl(t,\; I}
              \mln{\cat [\texttt{if\_false}\ a\ \texttt{goto}\ L_f]}
              \mln{\cat [\,t := \texttt{false},\;\texttt{goto}\ L_e\,]}
              \mln{\cat [\,L_f\texttt{:},\;t := \texttt{true},\;L_e\texttt{:}\,]\bigr)}
            }}
        \]
        \vspace{0.2em}
      \end{block}
      ...
      \begin{block}{Rule}
        ...
        \[
          \inferrule[AndExpr]
            ...
            {\vcenter{
              \mln{\trExpr{e_1 \mathbin{\texttt{\&\&}} e_2} \;\Rightarrow\; \bigl(t,\; I_1}
              \mln{\cat [\texttt{if\_false}\ a_1\ \texttt{goto}\ L_f]}
              \mln{\cat\; I_2 \cat [\texttt{if\_false}\ a_2\ \texttt{goto}\ L_f]}
              \mln{\cat [\,t := \texttt{true},\;\texttt{goto}\ L_e\,]}
              \mln{\cat [\,L_f\texttt{:},\;t := \texttt{false},\;L_e\texttt{:}\,]\bigr)}
            }}
        \]
        \vspace{0.1em}
      \end{block}
      ...
      \begin{block}{Rule}
        ...
        \[
          \inferrule[OrExpr]
            ...
            {\vcenter{
              \mln{\trExpr{e_1 \mathbin{\texttt{||}} e_2} \;\Rightarrow\; \bigl(t,\; I_1}
              \mln{\cat [\texttt{if\_false}\ a_1\ \texttt{goto}\ L_f,\;\texttt{goto}\ L_t]}
              \mln{\cat [\,L_f\texttt{:}\,] \cat\; I_2}
              \mln{\cat [\texttt{if}\ a_2\ \texttt{goto}\ L_t]}
              \mln{\cat [\,t := \texttt{false},\;\texttt{goto}\ L_e\,]}
              \mln{\cat [\,L_t\texttt{:},\;t := \texttt{true},\;L_e\texttt{:}\,]\bigr)}
            }}
        \]
        \vspace{0.1em}
      \end{block}
